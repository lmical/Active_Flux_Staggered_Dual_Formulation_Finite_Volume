...
\title[]{\textcolor{white}{\bfseries A New Semi-Discrete\\ Finite-Volume Active Flux Method for Hyperbolic Conservation Laws\\
...with application to multifluid flows}}
...
\institute[NCSU] % (optional)
{
  ...
  2025 SIAM Conference on Analysis of Partial Differential Equations, Pittsbugh, Pennsylvania, November 2025}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begingroup
\title[]{\textcolor{white}{\bfseries Dual Formulation Finite-Volume Methods on Overlapping Meshes for Hyperbolic Conservation Laws\\
		...with application to multifluid flows}}
...
\begin{frame}
	\frametitle{Further perspectives}
		...
		\begin{itemize}
			...
			\item AP scheme for Euler (with A.Chertock, A.Kurganov, S.Karni)
			\item AP scheme for TRSW (with A.Chertock, A.Kurganov, N.Zhang)
