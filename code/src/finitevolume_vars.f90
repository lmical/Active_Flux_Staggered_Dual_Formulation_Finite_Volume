...
REAL                :: scaling_factor_relaxed_dt
...
#if defined(ACTIVEFLUX) || defined(CENTEREDPRIMITIVE)
#ifdef IMEX
REAL,PARAMETER      :: SAFETY_K_TO_AVOID_HYPERBOLICITY_LOSS = 0.0!10.0
#endif
#ifdef MULTIFLUID
...
REAL,    ALLOCATABLE :: Errors_CELLS_AF(:,:,:)
REAL,    ALLOCATABLE :: Errors_INTERFACES_AF(:,:,:)
#endif
