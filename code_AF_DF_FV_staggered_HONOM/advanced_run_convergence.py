...
# time_schemes         =[3]
# post_processings     =[0]
# N_refinements = {1:5,2:5,20:5,21:5,22:5,23:5,24:5,25:5,26:5,27:5,-1:5,-2:5,-20:5,-21:5,-22:5,-23:5,-24:5,-25:5,-26:5,-27:5}
...
# nametest="sod2d_"+str(starting_elements_X)
...
# numbertest=13
# starting_elements_X=1200
# starting_elements_Y=601
# nametest="shock_vortex_"+str(starting_elements_X)+"_"+str(starting_elements_Y)
# space_reconstructions = [-27] #-np.array([-1, -20, -21, -22, -23, -24, -26]) #put sign -
# time_schemes         =[3]
# post_processings     =[12]
# N_refinements = {1:1,2:1,20:1,21:1,22:1,23:1,24:1,25:1,26:1,27:1,-1:1,-2:1,-20:1,-21:1,-22:1,-23:1,-24:1,-25:1,-26:1,-27:1}
...
# nametest="sod_"+str(starting_elements_X)
# space_reconstructions = [-27] #-np.array([-1, -20, -21, -22, -23, -24, -26]) #put sign -
# time_schemes         =[3]
# post_processings     =[12]
# N_refinements = {1:1,2:1,20:1,21:1,22:1,23:1,24:1,25:1,26:1,27:1,-1:1,-2:1,-20:1,-21:1,-22:1,-23:1,-24:1,-25:1,-26:1,-27:1}
...
# numbertest=-300
# starting_elements_X=1000
# nametest="shock_turbulence_interaction_shu_osher_"+str(starting_elements_X)
# space_reconstructions = [-27] #-np.array([-1, -20, -21, -22, -23, -24, -26]) #put sign -
# time_schemes         =[3]
# post_processings     =[12]
# N_refinements = {1:1,2:1,20:1,21:1,22:1,23:1,24:1,25:1,26:1,27:1,-1:1,-2:1,-20:1,-21:1,-22:1,-23:1,-24:1,-25:1,-26:1,-27:1}
...
# numbertest=402
# starting_elements_X=200
# nametest="RP2_"+str(starting_elements_X)
# space_reconstructions = [-27] #-np.array([-1, -20, -21, -22, -23, -24, -26]) #put sign -
# time_schemes         =[3]
# post_processings     =[12]
# N_refinements = {1:1,2:1,20:1,21:1,22:1,23:1,24:1,25:1,-1:1,-2:1,-20:1,-21:1,-22:1,-23:1,-24:1,-25:1,-26:1,-27:1}
# starting_elements_X_dict = {key: starting_elements_X for key in space_reconstructions}  # use elements of 'orders' as keys
# test_type="1D" #"1D" #"2D" #Depending on this I will modify or not the elements in the Y direction
# starting_elements_Y=3
# starting_elements_Y_dict = {key: starting_elements_Y for key in space_reconstructions}  # use elements of 'orders' as keys
