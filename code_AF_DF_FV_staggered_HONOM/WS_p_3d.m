...
folder = 'simulations_paper/sod2d_400/space_reconstruction-27/time_scheme_3/PP-1/CFL0.475/';
mesh_x_file = fullfile(folder, 'WS_MESH_CoordinateX.dat');
mesh_y_file = fullfile(folder, 'WS_MESH_CoordinateY.dat');
solution_file = fullfile(folder, 'WS_SOLUTION_OCT_0000000.2500000.dat');
...
surf(X, Y, P, P, 'EdgeColor', 'none');
colormap('parula');
colorbar;
title('p', 'FontWeight', 'normal');
%xlabel('x');
%ylabel('y');
...
saveas(gcf, 'sod2d_V_X_3d_pressure.pdf') % Save as vector PDF (HQ)
