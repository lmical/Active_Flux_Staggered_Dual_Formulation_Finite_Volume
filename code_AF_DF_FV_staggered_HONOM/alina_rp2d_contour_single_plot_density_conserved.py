...
folder="simulations_paper/2d_riemann_problem_1000/space_reconstruction-27/time_scheme_3/PP12/CFL0.475/"
# folder="simulations_paper/sod2d_200_200/space_reconstruction-27/time_scheme_3/PP1/CFL0.25/"
# folder="simulations_reconstruction_V_for_update_U/2d_riemann_problem_1000/space_reconstruction-27/time_scheme_3/PP-11/CFL0.475/"
filename = "SOLUTION_OCT_0000001.0000000.dat"
...
def plotting(folder_name, filename, what_plot='all', n_levels=20):
    ...
    def plot_data_step():
        ...
        for key, ax in axes.items():
            if key in plot_data:
                ...
                contours[key] = ax.contourf(X, Y, data, levels=levels, cmap=which_tone, vmin=0.129305722006904, vmax=1.73558996600877)
                ...
                ax.set_title(title_dict.get(key, key),fontsize=28)
                # ax.set_xlabel('x')
                # ax.set_ylabel('y')
                ax.set_aspect(aspect_ratio_dimensions[0] / aspect_ratio_dimensions[1])
                # --- ADD THIS LINE ---
                ax.tick_params(axis='both', which='major', labelsize=28) # You can change 14 to your desired size
    ...
    plt.tight_layout()
    plt.savefig("rp2d_U_contour_density.pdf", format="pdf", bbox_inches="tight")
    # plt.savefig("rp2d_U_contour_density_V_at_corners.pdf", format="pdf", bbox_inches="tight")
    # plt.show()
...
if __name__ == '__main__':
    ...
    plotting(folder_name, filename, 'density', n_levels=60) #48 #70
