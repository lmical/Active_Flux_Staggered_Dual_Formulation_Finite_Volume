...
surf(X, Y, ENERGY, ENERGY, 'EdgeColor', 'none')
...
axis tight
daspect([4 4 4]) % Adjust aspect ratio for clarity
...
saveas(gcf, 'sod2d_U_3d_energy.pdf') % Save as vector PDF (HQ)
% Or save as PNG with high resolution (if preferred)
%print(gcf, 'sod2d_U_3d_energy.png', '-dpng', '-r300') % 300 DPI for high-res PNG
