...
PRINT*, "Positivity flag active"
#else
PRINT*, "Positivity flag disabled"
#endif
PRINT*, "--------------------------"
...
PRINT*, "--------------------------"
  ...
  PRINT*, "STAGGERED active"
#ifdef ONEPOINTFLUX
  PRINT*, "...with ONEPOINTFLUX active"
#endif
#ifdef RECONSTRUCTIONOFVFORUPDATEOFU
  PRINT*, "...with RECONSTRUCTIONOFVFORUPDATEOFU active"
#endif
#else
  PRINT*, "YOU CANNOT BE HERE"
  STOP
#endif
...
#ifdef PRIMITIVEONLY
#if !defined(ACTIVEFLUX) && !defined(STAGGERED)
  PRINT*, "Impossible to evolve only primitive variables without Active Flux or STAGGERED flag."
  STOP
#endif
#endif
...
#if (defined(ACTIVEFLUX) + defined(CENTEREDPRIMITIVE) + defined(STAGGERED) ) > 1
  PRINT*, "Impossible to have multiple flags active between ACTIVEFLUX, CENTEREDPRIMITIVE, STAGGERED"
  STOP
#endif
...
PRINT*, "Gamma 2", Gmm2
#if !defined(ACTIVEFLUX) && !defined(STAGGERED)
PRINT*, "Impossible to run Multifluid without ACTIVEFLUX or STAGGERED"
STOP
#endif
...
#if defined(RECONSTRUCTIONOFVFORUPDATEOFU) && !defined(STAGGERED)
PRINT*, "RECONSTRUCTIONOFVFORUPDATEOFU requires STAGGERED"
PRINT*, "Activate STAGGERED in makefile."
STOP 
#endif
