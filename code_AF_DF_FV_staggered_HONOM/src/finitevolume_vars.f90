...
#ifdef STAGGERED
REAL,ALLOCATABLE    :: MeshBary_S(:,:,:)
REAL,ALLOCATABLE    :: MeshGP_S(:,:,:,:,:)
REAL,ALLOCATABLE    :: WS(:,:,:)
REAL,ALLOCATABLE    :: WSt(:,:,:)
REAL,ALLOCATABLE    :: UN0_WS(:,:,:)
REAL,ALLOCATABLE    :: K0_WS(:,:,:)
REAL,ALLOCATABLE    :: K1_WS(:,:,:)
REAL,ALLOCATABLE    :: K2_WS(:,:,:)
REAL,ALLOCATABLE    :: K3_WS(:,:,:)
REAL,ALLOCATABLE    :: K4_WS(:,:,:)
REAL,ALLOCATABLE    :: K5_WS(:,:,:)
REAL,ALLOCATABLE    :: FWp_WS(:,:,:,:)
REAL,ALLOCATABLE    :: Wp_WS(:,:,:,:)
REAL,ALLOCATABLE    :: Wa_WS(:,:,:,:)
REAL,ALLOCATABLE    :: W_qp(:,:,:,:) !*For order higher than 2 actually
#endif
...
#endif
#ifdef STAGGERED
INTEGER, ALLOCATABLE :: Troubled_Cell_WS(:,:)
#endif
