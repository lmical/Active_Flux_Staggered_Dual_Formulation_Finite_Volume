...
! #endif
! #ifdef STAGGERED
!     PRINT*, "WS ", iVar, MAXVAL(WS(iVar,1:nElemsX+1,1:nElemsY+1)), MINVAL(WS(iVar,1:nElemsX+1,1:nElemsY+1))
! #endif
!   END DO
!   PRINT*
  !*=========================================================
...
#endif
#ifdef STAGGERED
K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = WS(1:nVar,1:nElemsX+1,1:nElemsY+1)
#endif
...
#endif
#ifdef STAGGERED
K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = &    
    K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &  
  + WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt 
WS(1:nVar,1:nElemsX+1,1:nElemsY+1)  = K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) 
#endif
...
#endif
#ifdef STAGGERED
K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = &
    0.5*K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.5*K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.5*WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
WS(1:nVar,1:nElemsX+1,1:nElemsY+1)  = K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)
#endif
...
#endif
#ifdef STAGGERED
K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)= WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)
WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = &
    K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
#endif
...
#endif
#ifdef STAGGERED
K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)
WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) + &
          0.25*K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt+0.25*K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt 
#endif
...
#ifdef STAGGERED
!*Staggering in X direction
K3_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)
WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) + &
          1./6.*K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt+&
          1./6.*K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt+&
          2./3.*K3_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
#endif
...
#ifdef STAGGERED
K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = &
    1.00000000000000*K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.39175222700392*WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
WS(1:nVar,1:nElemsX+1,1:nElemsY+1)  = K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)
#endif
...
#ifdef STAGGERED
K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = &
    0.44437049406734*K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.55562950593266*K1_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.36841059262959*WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
WS(1:nVar,1:nElemsX+1,1:nElemsY+1)  = K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)
#endif
...
#ifdef STAGGERED
K3_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = &
    0.62010185138540*K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.37989814861460*K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.25189177424738*WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
WS(1:nVar,1:nElemsX+1,1:nElemsY+1)  = K3_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)
#endif
...
#ifdef STAGGERED
K4_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = &
    0.17807995410773*K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.82192004589227*K3_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.54497475021237*WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
WS(1:nVar,1:nElemsX+1,1:nElemsY+1)  = K4_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)
K5_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) = WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)
#endif
...
#ifdef STAGGERED
WS(1:nVar,1:nElemsX+1,1:nElemsY+1)  = &
    0.00683325884039*K0_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.51723167208978*K2_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.12759831133288*K3_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.34833675773694*K4_WS(1:nVar,1:nElemsX+1,1:nElemsY+1) &
  + 0.08460416338212*K5_WS(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt &
  + 0.22600748319395*WSt(1:nVar,1:nElemsX+1,1:nElemsY+1)*dt
#endif
